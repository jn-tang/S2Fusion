# This file is adopted from https://github.com/sanweiliti/EgoHMR/blob/main/models/respointnet.py
...
def create_point_enc(conf: DictConfig):
    model = ResnetPointnet(conf.out_dim, conf.hidden_dim)
    model.load_state_dict(torch.load(os.path.expanduser(conf.ckpt)))
    model.eval()
...
class ResnetPointnet(nn.Module):
    ...
    def __init__(self, out_dim, hidden_dim, ckpt=None):
        super().__init__()
