# Code adopted from https://github.com/nghorbani/body_visualizer/blob/master/src/body_visualizer/mesh/mesh_viewer.py
...
class MeshViewer(object):
    ...
    def set_background_color(self, color=Color.WHITE):
        self.scene.bg_color = np.array(color.value)
